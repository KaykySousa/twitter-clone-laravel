...
<body>
    <div class="h-screen w-full flex flex-col">
        <header class="flex h-14 px-4 justify-between items-center">
            ...
            <button class="h-8 bg-sky-500 rounded-2xl px-4 font-bold text-white text-sm">Tweet</button>
        </header>
        <main class="flex-1 flex flex-col">
            <div class="w-full flex px-4">
                ...
                <div class="flex-1">
                    <form action="" class="w-full flex flex-col border-b border-gray-100 pl-3">
                        ...
                        <textarea class="mt-6 resize-y h-24 mb-3" placeholder="What's happening?"></textarea>
